...
const Home: React.FC = () => {
 ...
 return (
 <div className="flex-1 p-6 md:p-10 lg:p-12 overflow-y-auto custom-scrollbar relative bg-darkBg">
 ...
 className="glass-panel px-6 py-4 rounded-xl flex items-center gap-4 border-border-color/10 shadow-xl group cursor-default"
 >
 ...
 {streak} <span className="text-sm text-textSec/50 font-medium">DAYS</span>
 </div>
 </div>
 </motion.div>
 </motion.div>
 ...
 whileHover={{ y: -3, backgroundColor: 'rgba(var(--border-color), 0.06)' }}
 className="glass-panel p-6 rounded-2xl border border-border-color/10 relative overflow-hidden group transition-all"
 >
 <div className={`absolute -right-4 -top-4 w-20 h-20 rounded-full blur-[40px] ${stat.glow}`}></div>
 <div className="flex items-center gap-5">
 <div className="w-12 h-12 rounded-xl bg-panelBg/40 flex items-center justify-center border border-border-color/10 group-hover:bg-white/5 transition-colors">
 {stat.icon}
 </div>
 <div>
 ...
 <p className="text-[11px] text-textSec/50 font-medium mt-3">{stat.desc}</p>
 </motion.div>
 ))}
 </div>
 ...
 <button className="flex items-center gap-3 px-8 py-4 bg-accentGlow text-textMain text-sm font-extrabold rounded-xl hover:opacity-90 transition-all active:scale-95 shadow-xl whitespace-nowrap shadow-glow">
 ...
 className="glass-panel p-5 rounded-2xl border border-border-color/10 hover: cursor-pointer transition-all flex items-center justify-between group"
 >
 ...
 <Star size={10} className={`fill-current ${item.confidence_score > 0.8 ? 'text-accentGlow' : 'text-textSec/50'}`} />
 <span className="text-[10px] font-bold text-textSec/50 uppercase">Accuracy: {Math.round(item.confidence_score * 100)}%</span>
 </div>
 </div>
 </div>
 </div>
 <ArrowRight size={16} className="text-textSec/50 group-hover:text-textMain group-hover:translate-x-1 transition-all" />
 </motion.div>
 ))
 ) : (
 <div className="py-16 text-center glass-panel rounded-2xl border border-dashed border-border-color/10 text-textSec/50 text-xs font-bold uppercase tracking-widest ">No questions asked yet</div>
 )}
 </div>
 </div>
 ...
 <motion.div
 key={folder.id}
 whileHover={{ backgroundColor: 'rgba(var(--border-color), 0.06)', x: 4 }}
 className="glass-panel p-5 rounded-2xl border border-border-color/10 bg-panelBg hover:border-border-color/10 transition-all flex items-center justify-between group cursor-pointer shadow-lg"
 ...
 <Plus size={16} className="text-textSec/50 group-hover:text-accentGlow transition-transform group-hover:rotate-90 duration-300" />
 </motion.div>
 ))
 ) : (
 <div className="p-16 text-center glass-panel rounded-2xl border border-dashed border-border-color/10 text-textSec/50 text-xs font-bold uppercase tracking-widest leading-relaxed ">Ready to add files</div>
 )}
 </div>
 </div>
 </div>
